...
<body>
    ...
    <section class="products section1" id="products">
        ...
        <div class="box-container">
            <?php
                $req = $connect->prepare('select * from products p inner join categories c on category=c.id where p.id in (select product from wishlist where customer='.$_SESSION['id'].')');
                $req->execute();
